...
from dataloaders.dataset import Dataset, RandomCrop, RandomRotFlip, ToTensor

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='./Datasets/Pancreas', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='vnet_supervisedonly_Pan_60', help='model_name')
...
parser.add_argument('--labelnum', type=int,  default=60, help='num of labeled data')
