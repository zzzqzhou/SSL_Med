...
parser.add_argument('--exp', type=str,  default='vnet_supervisedonly_LA_80', help='model_name')
...
parser.add_argument('--labelnum', type=int,  default=80, help='num of labeled data')
