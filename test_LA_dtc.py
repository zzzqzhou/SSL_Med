...
parser.add_argument('--root_path', type=str, default='./Datasets/LA/npz_data/', help='Name of Experiment')
parser.add_argument('--model', type=str,  default='DTC_with_consis_weight_LA_1', help='model_name')
