...
from dataloaders.dataset import Dataset, RandomCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='./Datasets/Pancreas', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='UAMT_Pan', help='model_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            consistency_dist = consistency_criterion(outputs, ema_output) #(batch, 2, 96,96,96)
