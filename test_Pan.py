...
parser.add_argument('--model', type=str,  default='vnet_supervisedonly_Pan_60', help='model_name')
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')
parser.add_argument('--save_result', action='store_true', help='Save Results')
parser.add_argument('--ct_norm', action='store_true', help='Save Results')
FLAGS = parser.parse_args()

# ct_foreground = [85.41, 35.80]
