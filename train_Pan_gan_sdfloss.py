...
from networks.discriminator import FC3DDiscriminatorPan
...
parser.add_argument('--exp', type=str,  default='SDF_Pan_1', help='model_name')
...
if __name__ == '__main__':
    ...
    D = FC3DDiscriminatorPan(num_classes=num_classes - 1)
    D = D.cuda()
